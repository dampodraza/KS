  ...
  return (
    <>
      ...
      <p className='font-spartan-light leading-[23px] mt-4 mb-4'>
        ...
        rodzajem wsparcia, jaki aktualnie będzie najlepiej służyć ich
        realizacji. Oboje ustalamy zasady współpracy i decydujemy o kontynuacji
        naszych spotkań coachingowych. W trakcie trwania procesu pracujemy
        wspólnie nad realizacją Twoich celów. W pakiecie otrzymujesz również
        moje autorskie ćwiczenia coachingowe wspierające Twój rozwój oraz czas
        wsparcia mailowego, po zakończeniu spotkań. Na zakończenie dodatkowo,
