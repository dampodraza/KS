  ...
  return (
    ...
    <section className='flex items-center justify-center bg-[#F8F3F0]'>
      <div className='grid items-center gap-4 px-10 md:grid-cols-1 md:px-20'>
        <p className='pb-8 text-center font-spartan-bold text-3xl md:pb-4 md:text-4xl md:leading-[45px]'>
          Świat potrzebuje takich ludzi jak Ty.<br></br>A Ty potrzebujesz takich
          ludzi jak ja.
        </p>
        <div className='grid grid-cols-1 gap-4 text-center font-spartan-light text-base leading-[18px] md:text-xl md:leading-8 md:gap-0 md:px-18'>
