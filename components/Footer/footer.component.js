...
const Footer = () => {
  return (
    <footer className="flex items-center h-[247px] bg-black text-white	">
      <div className="flex justify-between flex-col px-7 w-full md:flex-row md:px-48 md:items-center">
      <p className="text-lg font-spartan-bold text-center mb-4 md:hidden">Kontakt</p>
        <div className="flex flex-col align-left mb-4 pl-14 md:pl-0 md:mb-0">
          <div className="flex flex-row mb-4 md:mb-6">
            ...
            <Link href="tel:535-525-235" passHref={true}>
              <p className=" text-lg ml-4 cursor-pointer md:text-2xl">535-525-235</p>
            </Link>
          </div>
          <div className="flex flex-rowjustify-center">
            <Image src={mailIcon} alt="mail" width={35} height={32} />
            <p className="text-sm ml-4 underline md:text-2xl">kasia.maria.podraza@gmail.com</p>
          </div>
        </div>
        <div className="flex flex-col text-center gap-y-1">
          <p className="text-lg font-spartan-bold mb-2 md:text-2xl">Obserwuj mnie</p>
