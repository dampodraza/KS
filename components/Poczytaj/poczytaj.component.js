      ...
      <div className='mb-4 flex flex-row gap-x-4'>
        <div className='flex flex-col'>
          {postImage && (
            <div
              className={
                'relative h-auto w-[150px] overflow-hidden rounded-2xl sm:w-auto'
              }
            >
              <Image
                src={postImage}
        ...
        <div className='align-center flex flex-col justify-center'>
          <p className='text-sm font-bold uppercase sm:pt-2 sm:text-base'>
            {parse(postTitle)}
          </p>
          <div className='font-josefin text-xs sm:px-10 sm:pt-4 sm:text-sm'>
