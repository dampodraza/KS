  ...
  return (
    <>
      ...
      <section className='flex items-center justify-center '>
        ...
        <div className='flex flex-col items-center px-10	md:basis-8/12 md:items-baseline md:px-4 md:text-left	'>
          <p className='mb-2	font-spartan-bold text-2xl md:text-4xl	'>
            Dlaczego właśnie ja?
          </p>
          <Image
            src={kasiaDrawing}
            ...
            className='md:hidden'
          />
          <p className='pt-6 text-center font-spartan-light text-base leading-[26px] md:pb-12 md:text-left md:text-xl'>
